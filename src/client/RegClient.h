...
{
public:
    RegClient(EventLoop* loop, const InetAddress& serverAddr)
    :m_client(loop, serverAddr, "RegClient")
    {
        ...
        m_dispatcher.setDefaultCallback(std::bind(&RegClient::onUnknownMessage, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
        m_dispatcher.registerMessageCallback<User::RegRsp>(std::bind(&RegClient::handleRegister, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));

        m_client.setConnectionCallback(std::bind(&RegClient::onConnection, this, std::placeholders::_1));
