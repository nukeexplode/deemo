...
{
public:
    LoginClient(EventLoop* loop, const InetAddress& serverAddr)
    :m_client(loop, serverAddr, "LoginClient")
    {
        ...
        m_dispatcher.setDefaultCallback(std::bind(&LoginClient::onUnknownMessage, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
        m_dispatcher.registerMessageCallback<User::RegRsp>(std::bind(&LoginClient::handleRegister, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));

        m_client.setConnectionCallback(std::bind(&LoginClient::onConnection, this, std::placeholders::_1));
