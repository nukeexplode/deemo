...
{
public:
    ProxyClient(EventLoop* loop, const InetAddress& serverAddr)
    :m_client(loop, serverAddr, "ProxyClient")
    {
        ...
        m_dispatcher.setDefaultCallback(std::bind(&ProxyClient::onUnknownMessage, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
        m_dispatcher.registerMessageCallback<User::RegRsp>(std::bind(&ProxyClient::handleRegister, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
        m_dispatcher.registerMessageCallback<Msg2Proxy::LoginRsp>(std::bind(&ProxyClient::handleLogin, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));

        m_client.setConnectionCallback(std::bind(&ProxyClient::onConnection, this, std::placeholders::_1));
...
private:
    ...
    void handleLogin(const TcpConnectionPtr& conn, const std::shared_ptr<Msg2Proxy::LoginRsp>& rsp, Timestamp);
